...
Once I was confident about the signal I needed to send, I then swapped out the RX hardware for the TX hardware and wired it up to the Pi. I gain used the pin identifying picture from amazon and the [pinout mapping](https://pinout.xyz/) to do this.
